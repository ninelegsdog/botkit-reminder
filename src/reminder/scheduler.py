...
from src.reminder.repositories import BroadcastRecipientRepository, ReminderRepository
    ...
    async def _tick(self) -> None:
        ...
        try:
            async with self._session_factory() as session:
                ...
                due_once = await reminder_repo.get_due_once(now)
                due_recurring = await reminder_repo.get_recurring_by_weekday(weekday)
